...
public class seis extends AppCompatActivity {
    ...
    public void mensage() {
        AlertDialog.Builder dialogoAjustes = new AlertDialog.Builder(seis.this);
        dialogoAjustes.setTitle("Cambiar Cantidad de Cartas OwO");
        dialogoAjustes.setItems(R.array.seis, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:
                        Intent i = new Intent(seis.this,MainActivity.class);
                        startActivity(i);
                        break;

                    case 1:
                        Intent o = new Intent(seis.this, ocho.class);
                        startActivity(o);
                        break;
                }
            }
